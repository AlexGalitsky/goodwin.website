...
const projectsData = computed(() => {
  ...
  return {
    ...
    'virtueforge': {
      ...
      features: tm('projects.virtueforge.features'),
      links: {
        website: 'https://virtueforge.goodwin.website'
      },
      screenshots: [
        '/projects/virtueforge/1.jpg',
        '/projects/virtueforge/2.jpg',
        '/projects/virtueforge/3.jpg',
        '/projects/virtueforge/4.jpg',
        '/projects/virtueforge/5.jpg'
      ]
    },
    'vpn': {
      ...
      features: tm('projects.vpn.features'),
      links: {
        website: 'https://vpnclient.goodwin.website'
      },
      screenshots: [
        '/projects/vpn/1.jpg',
        '/projects/vpn/2.jpg',
