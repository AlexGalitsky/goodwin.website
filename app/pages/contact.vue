        ...
        <div class="max-w-xl">
          ...
          <div class="space-y-4">
            <a
              ...
              class="flex items-center gap-4 p-4 bg-card border border-primary/40 rounded-lg hover:border-primary transition-colors group"
            >
              <div class="flex items-center justify-center w-12 h-12 bg-primary/10 rounded-lg">
                <span class="font-mono text-sm text-primary">TG</span>
              </div>
              <div>
                <p class="font-mono text-xs text-muted-foreground mb-1">{{ $t('common.contactPrefer') }}</p>
                <p class="font-mono text-sm text-foreground group-hover:text-primary transition-colors">{{ $t('common.telegram') }}</p>
                <p class="font-mono text-xs text-muted-foreground">{{ $t('contact.telegramHandle') }}</p>
              </div>
            </a>
            ...
            >
              <div class="flex items-center justify-center w-12 h-12 bg-secondary rounded-lg group-hover:bg-primary/10 transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="h-5 w-5 text-muted-foreground group-hover:text-primary">
